package net.luckystudios.entity.custom.cannonball.types.wind_bomb;
...
public class WindBombRenderer extends AbstractCannonBallRenderer<net.luckystudios.entity.custom.cannonball.types.normal.CannonBall> {
