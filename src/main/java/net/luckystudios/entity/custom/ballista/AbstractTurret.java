...
// Copied from the BlockAttachedEntity class
public abstract class AbstractTurret extends AgeableMob {
    private static final Logger LOGGER = LogUtils.getLogger();
    private int checkInterval;
    protected BlockPos pos;

    protected AbstractTurret(EntityType<? extends AgeableMob> entityType, Level level) {
        super(entityType, level);
    }

    protected AbstractTurret(EntityType<? extends AgeableMob> entityType, Level level, BlockPos pos) {
