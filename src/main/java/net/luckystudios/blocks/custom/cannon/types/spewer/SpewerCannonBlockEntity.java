...
public class SpewerCannonBlockEntity extends AbstractShootingAimableBlockEntity {
    ...
    public @Nullable AbstractContainerMenu createMenu(int containerId, Inventory playerInventory, Player player) {
        return new SpewerCannonBlockBlockMenu(containerId, playerInventory, this);
    }
    ...
    public static void tick(Level level, BlockPos pos, BlockState state, SpewerCannonBlockEntity cannonBlockEntity) {
        ...
        if (cannonBlockEntity.cooldown == 1 && cannonBlockEntity.canShoot(cannonBlockEntity, true)) {
            fireCannon(level, pos, cannonBlockEntity);
        }
    }

    public static void fireCannon(Level level, BlockPos pos, SpewerCannonBlockEntity cannonBlockEntity) {
    ...
    private static AbstractCannonBall getCannonBall(Level level, Vec3 spawnPos, SpewerCannonBlockEntity cannonBlockEntity) {
