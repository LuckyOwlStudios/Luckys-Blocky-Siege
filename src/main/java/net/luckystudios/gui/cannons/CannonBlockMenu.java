...
import net.luckystudios.gui.slots.custom.CannonAmmoSlot;
...
public class CannonBlockMenu extends AbstractContainerMenu {
    ...
    public CannonBlockMenu(int containerId, Inventory inv, BlockEntity blockEntity) {
        ...
        if (!(this.blockEntity instanceof CannonBlockEntity cannonBlockEntity)) return;
        this.addSlot(new FuseSlot(cannonBlockEntity, 0, 40, 26, this));
        this.addSlot(new CannonAmmoSlot(cannonBlockEntity, 1, 80, 35, this));
    }
